...
Inital game created using jQuery. This updated 24 Game was created using the MERN stack with a React Framework for the frontend and Express and Node for the backend and MongoDB for the database.
